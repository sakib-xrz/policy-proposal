...
export default function ThreeInstalmentDocument({
  ...
  const [policyTermMode, setPolicyTermMode] = useState<PolicyTermMode>(18);
  ...
  const termYears = termOptions[policyTermMode];
    ...
    <>
      ...
      >
        ...
        {([18, 12] as const).map((term) => (
          ...
          >
            <input
              type="radio"
              name="three-instalment-term"
              checked={policyTermMode === term}
              onChange={() => setPolicyTermMode(term)}
              style={{ width: "16px", height: "16px", accentColor: "#2563eb" }}
            />
            <span>{termOptions[term].label}</span>
          </label>
        ))}
      </div>
      ...
      >
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <span style={{ fontWeight: "700" }}>{termYears.termText}</span>
        ...
        <div style={{ lineHeight: "2", textAlign: "justify" }}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <p style={{ marginBottom: "8px" }}>
              ...
              বীমার মেয়াদকালের মধ্যে বীমাগ্রাহকের মৃত্যু হলে বীমাকৃত সম্পূর্ণ
              টাকা এবং নির্ধারিত সময়ের বোনাস নমিনীকে প্রদান করা হয়। এটি এই বীমার
              সবচেয়ে আকর্ষণীয় দিক।
            </p>
          </div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <p style={{ marginBottom: "8px" }}>
              ...
              অন্যত্র বিনিয়োগ করে যে লভ্যাংশ পাবেন তা দিয়েই বীমা পলিসির
              প্রিমিয়াম জমা দেয়া সম্ভব। উপরন্ত প্রাপ্ত প্রথম কিস্তির টাকা মূলধন
              হিসেবে থেকে যাবে।
            </p>
            <p style={{ marginBottom: "8px" }}>
            ...
            <p style={{ marginBottom: "8px" }}>
              <strong>(গ)</strong> ৩য় কিস্তি (শেষ কিস্তি) হিসেবে বীমাগ্রহীতা
              পাবেন বীমা অংকের অবশিষ্ট ৫০% টাকা এবং নির্ধারিত সময়ের বোনাস।
            </p>
            <p style={{ marginBottom: "8px" }}>
