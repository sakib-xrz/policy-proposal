      ...
      <div>
        ...
        >
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; মেয়াদপূর্তিতে বয়সের জীবনের জন্য আজীবন পেনশনের ব্যবস্থা
            অথবা মেয়াদপূর্তিতে পেনশনের টাকার ৫০% অথবা ১০০% সমর্পণ (কম্যুটেশন)
            মূল্য পাওয়ার সুবিধা।
          </li>
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; পেনশন প্রদান শুরুর ১০ (দশ) বছরের মধ্যে মৃত্যু হলে দশ বছরের
            অবশিষ্ট সময়ের জন্য পেনশনভোগীর মনোনীতকের (নমিনি) পেনশন লাভের
            গ্যারান্টি।
          </li>
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; বীমাগ্রাহক বীমার মেয়াদের মধ্যে মৃত্যুবরণ করলে মনোনীত
            ব্যক্তিকে মৃত্যুর সাথে সাথেই বার্ষিক পেনশনের ৫ গুণ পরিমাণ অর্থ এবং
            মৃত্যুর পরবর্তী ১০ বছর পর্যন্ত বার্ষিক পেনশন প্রদান করা হবে।
          </li>
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; বীমার মেয়াদে শর্তানুযায়ী বীমাগ্রাহক পরিশোধিত মূল্য,
            সমর্পণ ও ঋণ গ্রহণ করার সুবিধা প্রাপ্য হবেন।
          </li>
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; প্রদত্ত প্রিমিয়ামের উপর আয়কর রেয়াত পাওয়া যাবে।
          </li>
          <li style={{ marginBottom: "12px", paddingLeft: "4px" }}>
            &#11166; এই বীমার সঙ্গে অতিরিক্ত সুবিধাবর বীমা Supplementary benefit
            গ্রহণ করা যাবে।
          </li>
